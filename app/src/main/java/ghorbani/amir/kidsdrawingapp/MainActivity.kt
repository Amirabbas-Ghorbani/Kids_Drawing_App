...
//            ContextCompat.getDrawable(this, R.drawable.pallet_selected))
        ...
        val ibBrush : ImageButton = findViewById(R.id.ib_brush_size)
        ...
        val ibCleanAll : ImageButton = findViewById(R.id.ib_Clear)
        ibCleanAll.setOnClickListener {
            drawingView?.onClickClearAll()
        }
    ...
    private fun requestStoragePermission(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            requestPermission.launch(arrayOf( // reminder: READ_EXTERNAL_STORAGE , I have implemented for android  - 13
                Manifest.permission.READ_MEDIA_IMAGES,
